...
public class ActivityHelp extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == imgEmail) {
            ...
            Map<String, Object> mail_eventValue = new HashMap<String, Object>();
            AppsFlyerLib.getInstance().trackEvent(context, "af_click_mail", mail_eventValue);
        ...
        if (v == imgWeb) {
            ...
            Map<String, Object> web_eventValue = new HashMap<String, Object>();
            AppsFlyerLib.getInstance().trackEvent(context, "af_click_globe", web_eventValue);
