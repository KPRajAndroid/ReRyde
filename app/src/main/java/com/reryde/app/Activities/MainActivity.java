...
import com.reryde.app.Fragments.Coupon;
import com.reryde.app.Fragments.Help;
import com.reryde.app.Fragments.HomeFragment;
import com.reryde.app.Fragments.Payment;
import com.reryde.app.Fragments.Wallet;
import com.reryde.app.Fragments.YourTrips;
...
import com.reryde.app.Utils.CustomTypefaceSpan;
...
public class MainActivity extends AppCompatActivity implements HomeFragment.HomeFragmentListener,
    ...
    RelativeLayout become_a_driver;
...
//        setSupportActionBar(toolbar);
        ...
        become_a_driver = (RelativeLayout) findViewById(R.id.become_a_driver);
        become_a_driver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Map<String, Object> click_Driver_eventValue = new HashMap<String, Object>();
                AppsFlyerLib.getInstance().trackEvent(context,"af_click_Driver",click_Driver_eventValue);

                startActivity(new Intent(context, BecomeDriverActivity.class));
            }
        });
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    CURRENT_TAG = TAG_HOME;
                        ...
                        AppsFlyerLib.getInstance().trackEvent(context,"af_view_home",eventValue);
                    ...
                    case R.id.nav_payment:
                        ...
                        Map<String, Object> nav_payment_eventValue = new HashMap<String, Object>();
                        AppsFlyerLib.getInstance().trackEvent(context,"af_click_payment",nav_payment_eventValue);
                    ...
                    case R.id.nav_yourtrips:
                      ...
                      /*  navItemIndex = 2;
                        ...
                        Map<String, Object> nav_yourtrips_eventValue = new HashMap<String, Object>();
                        AppsFlyerLib.getInstance().trackEvent(context,"af_click_triphistory",nav_yourtrips_eventValue);
                    ...
                    case R.id.nav_Notification:
                        ...
                        Map<String, Object> NotificationeventValue = new HashMap<String, Object>();
                        AppsFlyerLib.getInstance().trackEvent(context,"af_click_notification",NotificationeventValue);

                        Intent intent10 = new Intent(MainActivity.this, Notification.class);
                    ...
                    case R.id.passbook:
                      ...
                      /*  navItemIndex = 2;
                        ...
                        Map<String, Object> passbook_eventValue = new HashMap<String, Object>();
                        AppsFlyerLib.getInstance().trackEvent(context,"af_click_passbook",passbook_eventValue);
                    ...
                    case R.id.Free_ride:
                        ...
                        Map<String, Object> Free_ride_eventValue = new HashMap<String, Object>();
                        AppsFlyerLib.getInstance().trackEvent(context,"af_click_freeride",Free_ride_eventValue);
                    ...
                    case R.id.nav_coupon:
                       ...
                       /* navItemIndex = 3;
                        ...
                        Map<String, Object> coupon_eventValue = new HashMap<String, Object>();
                        AppsFlyerLib.getInstance().trackEvent(context,"af_click_promos",coupon_eventValue);
                    ...
                    case R.id.settings:
                        ...
                        Map<String, Object> settings_eventValue = new HashMap<String, Object>();
                        AppsFlyerLib.getInstance().trackEvent(context,"af_click_settings",settings_eventValue);
                    ...
                    case R.id.nav_wallet:
                        ...
                        Map<String, Object> wallet_eventValue = new HashMap<String, Object>();
                        AppsFlyerLib.getInstance().trackEvent(context,"af_click_wallet",wallet_eventValue);
                    ...
                    case R.id.nav_help:
                       ...
                       /* navItemIndex = 5;
                        ...
                        Map<String, Object> help_eventValue = new HashMap<String, Object>();
                        AppsFlyerLib.getInstance().trackEvent(context,"af_click_help",help_eventValue);
...
//                .requestIdToken("795253286119-p5b084skjnl7sll3s24ha310iotin5k4.apps.googleusercontent.com")
    ...
    public void navigateToShareScreen(String shareUrl) {
        try{
            ...
            String shareMessage = "Hey I'm using ReRyde. Lowest fare in town guaranteed! Download it now. ";
