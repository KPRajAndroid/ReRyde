...
//    public static final String base = "http://stagging.reryde.com/";
    ...
    public static final String LOGIN_URL = "http://reryde.com/api/user/login/otp";
    public static final String client_secret = "rhNfwAYIRWNTm9pwvpgduzFn0ClyvWHEkmfyDwUj";
//    public static final String STRIPE_TOKEN = "pk_test_EacUddWKtq5XqAt3dGdpr0YW";
    public static final String STRIPE_TOKEN = "pk_live_3TjV4AXGovbXtDVvqov4TF1D";
    public static final String Login = base + "api/user/login/otp";
    public static final String RegisterLogin = base + "api/user/otp";
    ...
    public static final String PAY_NOW_PAYPAL = base + "api/user/payment/status";
    public static final String PAYPAL_WALLET = base + "api/user/payment/paypal/paid";
    public static final String PAY_TIP = base + "api/user/tip";
    ...
    public static final String BECOME_DRIVER = base + "provider/register";
    public static final String CHECK_REFFERAL = base + "api/user/referral/check";
    ...
    public static final String GET_LOST_ITEM = base + "api/user/item";
    public static final String SEND_LOST_ITEM = base + "api/user/item";
    public static final String NOTIFICATION_LIST = base + "api/user/promocode/list";
    public static final String GET_SERVICE_LIST_FROM_ADDRESS = base + "api/user/get/service";
    public static final String FB_OTP = base + "api/user/sent/facebook/otp";
    public static final String FB_OTP_WITH_PHONE = base + "api/user/facebook/update";
